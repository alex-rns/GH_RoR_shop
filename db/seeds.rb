...
#E-drums
Product.create!(
  name: "Fame DD-Lite V2 E-Drum Set",
...
Product.create!(
  name: "Fame DD-5500 PRO E-Drum Kit",
...
Product.create!(
  name: "FAME DD-5500 Complete 1 - Set",
...
Product.create!(
  name: "Yamaha DTX452K E-Drum Set",
...
Product.create!(
  name: "Yamaha DTX482K Complete 1 - SET",
...
Product.create!(
  name: "Roland TD-17KVX Complete - SET",
...
Product.create!(
  name: "Roland TD-27K Practice - SET",
...
Product.create!(
  name: "Gewa G9 Pro C5 E-Drum Set",
...
Product.create!(
  name: "Roland TD-50K E-Drum Set UK-Version",
...
Product.create!(
  name: "Roland TD-50KVX E-Drum Set",
...
# Acoustic Drums Set
Product.create!(
  name: "Pearl RSJ465C Roadshow Junior Set Jet Black",
...
Product.create!(
  name: "PDP PDP Concept Maple CM7 Satin Charcoal Burst",
...
Product.create!(
  name: "Tama Superstar Classic CK52KR Vintage White Sparkle",
...
Product.create!(
  name: "Pearl Reference Pure RFP-924XEP/C, Black Cherry",
...
Product.create!(
  name: "Pearl Export EXX Snare 14x5.5, Jet Black",
...
Product.create!(
  name: "Pearl SFS10/C31 Short Fuse Snare 10x4,5, Jet Black",
...
Product.create!(
  name: "Tama Metalworks Black Steel Snare 14x5,5",
...
Product.create!(
  name: "Gretsch Full Range Ash Snare 10x6 Satin Ebony",
...
Product.create!(
  name: "Fame Maple Standard BassDrum, 16x14, Black",
...
Product.create!(
  name: "Pearl Export EXX BassDrum 22x18, Jet Black",
...
Product.create!(
  name: "Pearl Export EXL BassDrum 22x18, Natural Cherry",
...
Product.create!(
  name: "Sonor Vintage Series BassDrum 20x14, Vintage Pearl",
  description: "
...
Product.create!(
  name: "Yamaha Absolute Maple Hybrid BassDrum 20x16, Classic Walnut",
...
Product.create!(
  name: "Yamaha Recording Custom BassDrum 22x18, Solid Black",
...
Product.create!(
  name: "Tama Star Bubinga BassDrum 20x16, Dark Green Cordia ",
...
#
Product.create!(
  name: "Pearl Export EXX FloorTom 14x14, Arctic Sparkle",
...
Product.create!(
  name: "Gretsch Catalina Maple FloorTom 14x14, Aqua Sparkle",
...
Product.create!(
  name: "DW Design Acryl FloorTom 14x12, Clear",
...
Product.create!(
  name: "Sonor Vintage Series FloorTom 14x12, Vintage Pearl",
...
Product.create!(
  name: "Yamaha Absolute Maple Hybrid FloorTom 18x16, Classic Walnut",
...
Product.create!(
  name: "Tama Star Bubinga FloorTom 14x12, Dark Green Cordia",
  description: "The STAR series is the flag ship of Tama drums. The combination of premium materials with the absolute highest quality craftsmanship and attention to details results in an instrument which delivers benchmark professionalism and quality in aesthetics and sound.
The newly developed, rounded shell bearing edge ensures for a larger contact surface of the head allowing for better a transmission of vibrations from the head to the shell.
The tom mounts were also redeveloped and promise minimal stress on the hoops and claws with only three contact points.
Quick-Lock Tom- and Floor-Tom clamps make the setup and collapse of the drum-set much more comfortable. Additionally, the unique design of the clamps has made Memory Locks redundant.",
...
Product.create!(
  name: "Fame Spark Tom 13x11, Black",
...
Product.create!(
  name: "Pearl Export EXX Tom 12x8, Jet Black",
...
Product.create!(
  name: "Pearl Export EXL Tom 13x9, Natural Cherry",
...
Product.create!(
  name: "Gretsch Catalina Maple Tom 8x7, Aqua Sparkle",
...
Product.create!(
  name: "Mapex Armory Tom 8x7 Emerald Burst",
...
Product.create!(
  name: "DW Design Acryl Tom 8x7, Clear",
...
Product.create!(
  name: "Yamaha Recording Custom TomTom, 10x9, Real Wood",
  description: "North American birch serves as the basis for the recording custom drums, 6 layers of slowly grown wood are glued into a perfectly round bowl and provided with a burr of 30°. Specially weighted Hi-Tension Lugs should help to tickle lower frequencies out of the wood. Despite the revised, more modern design, the Recording Custom Drums retain the classic look that has shaped the drum world for so many years. Due to the increased weight of the brackets, it has been possible to make optimum use of the damping properties of birch wood and to reduce unwanted frequencies without using extra damping. This results in optimal sustain for the core sound and thus in a crisp, articulated tone.",
  price: 428,
...
Product.create!(
  name: "Yamaha Absolute Maple Hybrid Tom 10x8 Gold Champagne Sparkle",
...
Product.create!(
  name: "Tama Star Bubinga Tom 10x8, Dark Green Cordia",
  description: "The STAR series is the flag ship of Tama drums. The combination of premium materials with the absolute highest quality craftsmanship and attention to details results in an instrument which delivers benchmark professionalism and quality in aesthetics and sound.
The newly developed, rounded shell bearing edge ensures for a larger contact surface of the head allowing for better a transmission of vibrations from the head to the shell.
The tom mounts were also redeveloped and promise minimal stress on the hoops and claws with only three contact points.",
  price: 650,
...
Product.create!(
  name: "Yamaha Absolute Maple Hybrid Tom 16x14, Classic Walnut",
...
Product.create!(
  name: "Paiste 102 Brass Cymbal Set Essential 14 HiHat, 18 Crash Ride",
...
Product.create!(
  name: "Zildjian Planet Z Launch Pack 13HH, 16CR",
...
Product.create!(
  name: "Zildjian I Family Expression Cymbal Pack 1",
...
Product.create!(
  name: "Paiste PST8 Rock Effects Cymbal Set, 10SP, 18CH",
...
Product.create!(
  name: "Meinl HCS Cymbal Set 20 Ride,16 Crash,14 HiHat",
...
Product.create!(
  name: "Meinl Byzance Cymbal Set MJ401+18",
...
Product.create!(
  name: "Meinl B14161820DU Byzance Cymbal Set Dual Complete",
...
Product.create!(
  name: "Meinl Classics Custom Dark Cymbal Set",
...
Product.create!(
  name: "Paiste CS 900 Cymbal Set Rock Color Sound Black",
...
Product.create!(
  name: "Meinl HCS Ultimate Cymbal Set HCS-SCS1",
...
Product.create!(
  name: "Paiste 101 Brass Crash Ride 18",
...
Product.create!(
  name: "Paiste 900 Series Heavy Ride 20",
...
Product.create!(
  name: "Paiste CS 900 Heavy Ride 20 Color Sound Purple",
...
Product.create!(
  name: "Meinl Classics Custom Dark Heavy Ride 20",
...
Product.create!(
  name: "Paiste 900 Series Ride 22",
...
Product.create!(
  name: "Zildjian GEN16 Buffed Bronze Ride 20",
...
Product.create!(
  name: "Meinl Byzance Dark Ride 22, B22DAR, Dark Finish",
...
Product.create!(
  name: "Paiste Twenty MC Dark Crisp Ride 22, Masters Collection",
  description: "
...
Product.create!(
  name: "Meinl B24PMR-B Byzance Pure Metal Ride 24 Chris Adler Signature",
...
Product.create!(
  name: "Fame Reflex Crash 14 (Silver)",
...
Product.create!(
  name: "Fame Noiseless Crash 16 (Brilliant)",
...
Product.create!(
  name: "T-Cymbals T-Natural Medium Crash 15",
...
Product.create!(
  name: "Meinl Classics Custom Crash 16 CC16EMC-B, Extreme Metal",
...
Product.create!(
  name: "Fame Pure Hybrid Thin Crash 16 (Natural/Hammered)",
...
Product.create!(
  name: "T-Cymbals Punkhead Crash 17",
...
Product.create!(
  name: "T-Cymbals Punkhead Crash 19",
...
Product.create!(
  name: "Zildjian K1428 K Custom Special Dry Crash 22",
...
Product.create!(
  name: "Paiste PST5 Sound-Edge HiHat 14, Version 2015",
...
Product.create!(
  name: "Meinl Generation X, FX Hat 10, GX-10FXH",
...
Product.create!(
  name: "Paiste CS 900 Sound Edge HiHat 14 Color Sound Blue",
...
Product.create!(
  name: "Zildjian GEN16 Buffed Bronze HiHat 13",
...
Product.create!(
  name: "Meinl Byzance Medium Thin HiHat 16, B16EDMTH, Extra Dry Finish",
...
Product.create!(
  name: "Sabian HHX Evolution HiHat 14 Brilliant",
...
Product.create!(
  name: "Meinl Byzance Dual HiHat 15, B15DUH, Extra Dry",
...
Product.create!(
  name: "Ortega Cajon Pedal OCJP-GB, inkl. Bag",
...
Product.create!(
  name: "Tama POWER GLIDE SINGLE PEDAL HP900PN",
...
Product.create!(
  name: "Rogers RP100 Dyno-Matic Einzelpedal",
...
Product.create!(
  name: "Sonor Giant Step Kick Pedal GSP3",
...
Product.create!(
  name: "DW Kick Pedal Direct Drive",
...
Product.create!(
  name: "AXIS PERCUSSION A-770 Single Pedal",
...
Product.create!(
  name: "Fame DFP9001 Double Pedal",
...
Product.create!(
  name: "Fame Doppelpedal DFP-ONE Chain Drive",
...
Product.create!(
  name: "Pearl P-2052C Eliminator Redline Double Pedal",
...
Product.create!(
  name: "Tama HP900PWLN Iron Cobra - Left",
...
Product.create!(
  name: "Yamaha DFP9C Double Foot Pedal (Double Chain Drive)",
...
Product.create!(
  name: "Sonor GDPR3 Double Pedal Giant Step",
...
Product.create!(
  name: "AXIS PERCUSSION A-702 Double Pedal",
...
Product.create!(
  name: "DW Double Pedal Direct Drive",
...
Product.create!(
  name: "MUSIC STORE 5A Maple Sticks, Wood Tip",
...
Product.create!(
  name: "MUSIC STORE 5B Sticks, Hornbeam",
...
Product.create!(
  name: "Vic-Firth Nova Drum Sticks 7AB",
...
Product.create!(
  name: "Los Cabos 5A Red Hickory Sticks",
...
Product.create!(
  name: "Vic-Firth Vic Grip Sticks 7AVG, American Classic",
...
Product.create!(
  name: "PRO-MARK Mike Portnoy ActiveGrip 420X",
...
Product.create!(
  name: "Ice-Stix UV Light Sticks 5A",
...
Product.create!(
  name: "Ahead Armor Cases Cover for Drum Throne AA9024",
...
Product.create!(
  name: "Ahead Spinal Glide Throne SPG-R-4 Red",
...
Product.create!(
  name: "DW Drumhocker 9120AL AirLift",
...
Product.create!(
  name: "Pearl D-3500BR Roadster Drum Throne",
  description: "
...
Product.create!(
  name: "MUSIC STORE Practice Pad 7",
...
Product.create!(
  name: "Evans Practice Pad Real Feel RF-6GM, 6",
...
Product.create!(
  name: "EVANS Practice Pad RF + Stand - Set",
...
Product.create!(
  name: "Tama Practice Pad TDP7S Buzz Maker, 7, with Snaresound",
...
Product.create!(
  name: "RTOM BLKHOL14 Practice Pad Black Hole 14",
...
Product.create!(
  name: "Fame Padronome Practice Pad",
...
Product.create!(
  name: "Boss DB-90 Dr.Beat Digital-Metronom MIDI Slot",
...
Product.create!(
  name: "Fame FM-01B Digital Metronome",
...
Product.create!(
  name: "Audix DP8 Elite Pack drum case",
...
Product.create!(
  name: "Fame Drum Microphone Set Practice, 7-Piece",
...
Product.create!(
  name: "Vic-Firth DB22 Hearing Protection - Volume Reduction",
